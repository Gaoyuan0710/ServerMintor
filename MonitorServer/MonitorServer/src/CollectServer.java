...
import com.xiyou.Monitor.HttpServer.HttpServerInitializer;
import com.xiyou.Monitor.CollectServer.*;
    ...
    public static void CollectStart() {
        ...
        try {
            ...
            collect.group(bossGroup, workerGroup)
                    ...
                    .childHandler(new com.xiyou.Monitor.CollectServer.CollectServerInitializer());
